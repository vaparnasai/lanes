#Importing some useful packages,importing libraries for image processing and video editing tasks
#This line imports the pyplot module from Matplotlib, which is a plotting library for Python. It is typically used for visualization tasks
#This line imports the image module from Matplotlib, which provides functions to work with images.
#This line imports the NumPy library, which is commonly used for numerical computations in Python. It provides support for large, multi-dimensional arrays and matrices, along with a collection of mathematical functions to operate on these arrays.
#This line imports the OpenCV library, which is a popular computer vision library. It provides various functions for image and video processing tasks.
#This line imports the os module, which provides a way to interact with the operating system. It is often used for tasks such as file and directory manipulation.
#This line imports the glob module, which provides functions for file path expansion. It is commonly used to search for files that match a specified pattern.
#This line imports the VideoFileClip class from the moviepy.editor module, which is part of the MoviePy library. MoviePy is a Python library for video editing tasks.
